		...
		<div class="hide">
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 18.5 19" xml:space="preserve" class="colDin1">
				<symbol id="svg_facebook" >
					<path id="Facebook_Icon" class="st0" d="M17.4,9.5h-2.1V19h-3.2V9.5h-2.1V6.3h2.1V4.2c0-1.6-0.3-4.2,3.2-4.2h3.2v3.2h-2.1c-0.6,0-1,0.5-1.1,1.1v2.1h3.2L17.4,9.5z"/>
				</symbol>
			</svg>
...
<!-- 	FIN SVG -->
		...
		<nav id="nav" class="onlyDesktop">
			...
			<div id="menus">
<!-- 				<a href="<?php echo(base_url('servicios')); ?>"><div class="menu">Requisitos</div></a> -->
				<a href="javascript:void(0);"><div id="quees" class="menu">¿Qúe es?</div></a>
				<a href="javascript:void(0);"><div id="requisitos" class="menu">Requisitos</div></a>
				<a href="javascript:void(0);"><div id="precios" class="menu">Precios</div></a>
				<a href="javascript:void(0);"><div id="prueba" class="menu">Prueba</div></a>
				<a href="javascript:void(0);"><div id="contacto" class="menu">Contacto</div></a>
